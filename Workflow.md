...
Запуск JSON-сервера на порте 3123.
...
SALT='Salt for password hash' - соль для шифрования паролей
UPLOAD_DIRECTORY='./upload' - директория для сохранения загружаемых изображений
